...
// fs.readFile('./data/data-1.json', 'utf-8', (err, data1) => {
//     if (err) return console.error('file 1 error', err);
//     fs.readFile('./data/data-2.json', 'utf-8', (err, data2) => {
//         if (err) return console.error('file 2 error', err);

//         fs.readFile('./data/data-3.json', 'utf-8', (err, data3) => {
...
// fs.readFile('./data/data-1.json', 'utf-8').then((data1) => {
//     console.log("Read file one");
//     return fs.readFile('./data/data-2.json', 'utf-8').then((data2) => ({ data1, data2 }));
// }).then(({ data1, data2 }) => {
//     console.log("Read file two");
//     return fs.readFile('./data/data-3.json', 'utf-8').then((data3) => ({ data1, data2, data3 }));
...
async function readFiles() {
    const data1 = await fs.readFile('./data/data-1.json', 'utf-8');
    console.log("Read data file 1");

    const data2 = await fs.readFile('./data/data-2.json', 'utf-8');
    console.log("Read data file 2");

    const data3 = await fs.readFile('./data/data-2.json', 'utf-8');
